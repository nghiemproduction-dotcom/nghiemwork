...
export default function WeeklyReviewPage() {
  ...
  const weekTasks = useMemo(() => {
    return tasks.filter(
      t => t.status === 'done' && !t.parentId && t.completedAt && t.completedAt >= weekStart.getTime() && t.completedAt < weekEnd.getTime(),
    );
  ...
  const prevWeekTasks = useMemo(() => {
    return tasks.filter(
      t => t.status === 'done' && !t.parentId && t.completedAt && t.completedAt >= prevWeekStart.getTime() && t.completedAt < weekStart.getTime(),
    );
